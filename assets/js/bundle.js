...
;( function( $, w, d ){
	...
	$.fn.fsvs = function( _options ) {
		...
		var isCustomeScrollHandelerActive = false;
		...
		var customeScrollHandeler = function( e, callback ) {
			isCustomeScrollHandelerActive = true;
			handelerInterval = setInterval( function(){
				console.log(Date.now() - handelerStart);
				if( ( Date.now() - handelerStart ) > 100 ) {
					isCustomeScrollHandelerActive = false;
		...
		var mouseWheelHandler = function(e) {
			...
			if( ! isCustomeScrollHandelerActive ) {
				customeScrollHandeler( e, function(e){
